...
public class LieDetectorScript
{
    ...
    public static Pair<String, String> getImageBytes() {
        try {
            ...
            final File directory = new File("scripts/lieDetector");
            if (!directory.exists()) {
            ...
            try {
                return new Pair<String, String>(HexTool.toString(getBytesFromFile(new File("scripts/lieDetector/" + answer + ".jpg"))), answer);
            }
